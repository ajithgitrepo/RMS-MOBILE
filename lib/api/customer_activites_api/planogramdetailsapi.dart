    ...
    for (int u = 0; u < decodeddata['data'].length; u++) {
      if (decodeddata['data'][u]['category_name'] != null) {
        ...
        PlanoDetails.imageurl.add(
            "https://rms2.rhapsody.ae/planogram_image/${decodeddata['data'][u]['planogram_img']}");
        PlanoDetails.beforeimage.add(
            "https://rms2.rhapsody.ae/planogram_image/${decodeddata['data'][u]['before_image']}");
        PlanoDetails.afterimage.add(
            "https://rms2.rhapsody.ae/planogram_image/${decodeddata['data'][u]['after_image']}");
